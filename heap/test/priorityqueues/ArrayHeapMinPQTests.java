...
public class ArrayHeapMinPQTests extends BaseTest {
    ...
    void addFirstItem() {
        ExtrinsicMinPQ<Integer> pq = createMinPQ();
        pq.add(1, 1.0);
        assertThat(pq.contains(1)).isEqualTo(true);

    }
    @Test
    void swapFirst3NodesAdded(){
        ExtrinsicMinPQ<Integer> pq = createMinPQ();
        pq.add(1, 1.0);
        pq.add(2, 2.0);
        pq.add(3, 3.0);
        ...
        //
        // assertThat(pq.peekMin()).isEqualTo(4);
        // assertThat(pq.isEmpty()).isEqualTo(true);
        pq.peekMin();
    }

    @Test
    void swapNodesAfterAdding3Nodes() {
        ExtrinsicMinPQ<Integer> pq = createMinPQ();
        pq.add(1, 2.0);
        pq.add(2, 3.0);
        pq.add(3, 4.0);
    ...
    void addRemove3() {
        ...
        pq.changePriority("Gomez", 0);

        // assertThat(pq.peekMin()).isEqualTo("test");
    }
    ...
    void add10() {
        ...
        assertThat(pq.removeMin()).isEqualTo("Javert");
        assertThat(pq.removeMin()).isEqualTo("Cosette");
        assertThat(pq.removeMin()).isEqualTo("Marius");
        assertThat(pq.removeMin()).isEqualTo("Eponine");
        assertThat(pq.removeMin()).isEqualTo("Gavroche");
        assertThat(pq.removeMin()).isEqualTo("Fantine");
        // pq.removeMin();
        // pq.removeMin();
        // pq.removeMin();
        // pq.removeMin();
    ...
    void changePriority() {
        ...
        pq.changePriority(998, -1);

        assertThat(pq.peekMin()).isEqualTo(998);
    }
