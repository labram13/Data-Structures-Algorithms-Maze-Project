...
public abstract class BaseDequeTests extends BaseTest {
    ...
    @Test
    void get_at0__with1Item_returnsItem() { //failing this test
        Deque<String> deque = createDeque();
        deque.addFirst("s");
        String output = deque.get(0);
    ...
    */
    ...
    void dequesAddedCorrectly() {
        ...
        // Deque<String> deque2 = createDeque();
        // deque2.addLast("a");
        // deque2.addLast("b");
        // deque2.addFirst("c");
        // deque2.addLast("d");
